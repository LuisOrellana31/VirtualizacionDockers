...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CambioProductoProveedorComponent", function() { return CambioProductoProveedorComponent; });
/* harmony import */ var _raw_loader_cambio_producto_proveedor_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./cambio-producto-proveedor.component.html */ "MZX8");
/* harmony import */ var _cambio_producto_proveedor_component_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./cambio-producto-proveedor.component.css */ "b+Io");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _service_producto_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/producto.service */ "igYM");
...
/* harmony import */ var _listar_producto_listar_producto_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../listar-producto/listar-producto.component */ "9eMg");
...
let CambioProductoProveedorComponent = class CambioProductoProveedorComponent {
    constructor(fb, serviceProducto, http, dialog) {
        this.fb = fb;
    ...
    buscarProducto() {
        ...
        this.dialog.open(_listar_producto_listar_producto_component__WEBPACK_IMPORTED_MODULE_8__["ListarProductoComponent"], dialogConfig).afterClosed().subscribe(res => {
    ...
    asignarValoresProductoDanado(data) {
    ...
    cambiarProducto() {
        ...
        this.serviceProducto.CambioProducto(cambio).subscribe(data => {
            if (data.codigo == 1) {
...
CambioProductoProveedorComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
        _service_producto_service__WEBPACK_IMPORTED_MODULE_4__["ProductoService"],
...
/* harmony import */ var _raw_loader_crear_producto_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./crear-producto.component.html */ "3NR+");
/* harmony import */ var _crear_producto_component_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./crear-producto.component.css */ "4GUb");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! sweetalert2 */ "PSD3");
/* harmony import */ var sweetalert2__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(sweetalert2__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _service_producto_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../service/producto.service */ "igYM");
/* harmony import */ var _validator_Validaciones__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../validator/Validaciones */ "37jc");
/* harmony import */ var _proveedores_service_proveedor_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../proveedores/service/proveedor.service */ "7MfM");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
let CrearProductoComponent = class CrearProductoComponent {
    constructor(fb, serviceProducto, serviceProveedor) {
        this.fb = fb;
        this.serviceProducto = serviceProducto;
        this.serviceProveedor = serviceProveedor;
        this.listaProveedor = [];
        this.listaCategorias = [{ "nombre": "TODOS" }];
    ...
    crear() {
        if (this.formularioProducto.invalid) {
            ...
            this.serviceProducto.crearProducto(prod).subscribe(data => {
                if (data.codigo == 1) {
...
CrearProductoComponent.propDecorators = {
    txtpcedula: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_2__["ViewChild"], args: ['txtpcedula',] }]
};
CrearProductoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"],
        _service_producto_service__WEBPACK_IMPORTED_MODULE_5__["ProductoService"],
        _proveedores_service_proveedor_service__WEBPACK_IMPORTED_MODULE_7__["ProveedorService"]])
...
/* harmony import */ var _producto_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./producto-routing.module */ "f26X");
/* harmony import */ var _crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./crear-producto/crear-producto.component */ "F9+x");
...
/* harmony import */ var _cambio_producto_proveedor_cambio_producto_proveedor_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./cambio-producto-proveedor/cambio-producto-proveedor.component */ "1QeI");
/* harmony import */ var _listar_producto_lista_producto_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./listar-producto/lista-producto.module */ "Rmt6");
...
ProductoModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        declarations: [
            _crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_3__["CrearProductoComponent"],
            _cambio_producto_proveedor_cambio_producto_proveedor_component__WEBPACK_IMPORTED_MODULE_6__["CambioProductoProveedorComponent"]
        ],
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"],
            _producto_routing_module__WEBPACK_IMPORTED_MODULE_2__["ProductoRoutingModule"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"],
            _listar_producto_lista_producto_module__WEBPACK_IMPORTED_MODULE_7__["ListaProductoModule"],
...
/* harmony import */ var _listar_producto_listar_producto_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listar-producto/listar-producto.component */ "9eMg");
/* harmony import */ var _crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./crear-producto/crear-producto.component */ "F9+x");
/* harmony import */ var _cambio_producto_proveedor_cambio_producto_proveedor_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./cambio-producto-proveedor/cambio-producto-proveedor.component */ "1QeI");
...
const routes = [
    {
        path: '',
        children: [
            { path: 'listar', component: _listar_producto_listar_producto_component__WEBPACK_IMPORTED_MODULE_2__["ListarProductoComponent"] },
            { path: 'crear', component: _crear_producto_crear_producto_component__WEBPACK_IMPORTED_MODULE_3__["CrearProductoComponent"] },
            { path: 'cambioproveedor', component: _cambio_producto_proveedor_cambio_producto_proveedor_component__WEBPACK_IMPORTED_MODULE_4__["CambioProductoProveedorComponent"] },
