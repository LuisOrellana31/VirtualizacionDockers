...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListarProductoComponent", function() { return ListarProductoComponent; });
/* harmony import */ var _raw_loader_listar_producto_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! raw-loader!./listar-producto.component.html */ "tTCf");
/* harmony import */ var _listar_producto_component_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./listar-producto.component.css */ "66QR");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _service_producto_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../service/producto.service */ "igYM");
...
let ListarProductoComponent = class ListarProductoComponent {
    constructor(productoService, fb, router, dialogRef) {
    ...
    ngOnInit() {
        ...
        (_a = this.miFormulario.get('categoria')) === null || _a === void 0 ? void 0 : _a.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["switchMap"])(cat => this.productoService.listarporCategoria(cat))).subscribe(Categoriasproductos => {
...
ListarProductoComponent = __decorate([
    ...
    __metadata("design:paramtypes", [_service_producto_service__WEBPACK_IMPORTED_MODULE_3__["ProductoService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ListaProductoModule", function() { return ListaProductoModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "ofXK");
/* harmony import */ var _listar_producto_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./listar-producto.component */ "9eMg");
...
let ListaProductoModule = class ListaProductoModule {
};
ListaProductoModule = __decorate([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
        declarations: [
            _listar_producto_component__WEBPACK_IMPORTED_MODULE_2__["ListarProductoComponent"]
        ],
        imports: [
...
let ProductoService = class ProductoService {
    ...
    crearProducto(prod) {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].ip + 'inventario/guardarProductoInventario';
        return this.http.post(url, prod, { headers: { 'Content-Type': 'application/json; charset=UTF-8' } });
    }
    listaCategoria() {
    ...
    BuscarProductoSerie(numeroSerie) {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].ip + 'inventario/productoSerie?numeroSerie=' + numeroSerie;
        return this.http.get(url);
    }
    CambioProducto(cambio) {
        const url = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].ip + 'inventario/guardarCambioProducto';
        return this.http.post(url, cambio, { headers: { 'Content-Type': 'application/json; charset=UTF-8' } });
    }
};
...
//# sourceMappingURL=default~garantia-garantia-module~producto-producto-module-es2015.js.map